    ...
    <div className="flex-1 flex flex-col min-h-0 bg-primary">
      <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div className="flex items-center flex-shrink-0 px-4">
          <h1 className="text-white text-2xl font-bold">Acme Checkout</h1>
        </div>
          ...
          {navItems.map(item => {
            ...
            return (
              <Link key={item.name} href={item.href}>
                <a
                  className={cn(
                    isActive ? 'bg-primary-foreground/20 text-white' : 'text-white hover:bg-primary-foreground/10',
        ...
        <div className="flex-shrink-0 w-full group block">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs font-medium text-primary-foreground/80">View profile</p>
            </div>
          </div>
        </div>
      </div>
