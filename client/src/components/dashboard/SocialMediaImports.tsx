    ...
    <div className="mt-8">
      ...
      <div className="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {socialPlatforms.map((platform) => (
          <div key={platform.name} className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
            <div className="px-4 py-5 sm:p-6 text-center">
              <div className={`mx-auto mb-3 flex items-center justify-center h-12 w-12 rounded-full ${platform.bgColor}`}>
              ...
              <Button
                ...
                className="mt-4"
              >
                {importingPlatform === platform.platform ? "Connecting..." : "Connect"}
              </Button>
            </div>
          </div>
        ))}
