...
export interface IStorage {
  ...
  getProductRevenue(
    ...
    startDate?: Date,
    endDate?: Date
  ): Promise<{ productId: number; name: string; revenue: number }[]>
...
export class MemStorage implements IStorage {
  ...
  private initSampleData() {
    ...
    const categories = [
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
      ...
      },
      {
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
        userId: createdUser.id
      },
      {
        name: 'Electronics',
        ...
        imageUrl:
          'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
        userId: createdUser.id
      }
    ]
    ...
    const products = [
      {
        ...
        cost: 80.0,
        imageUrl:
          'https://images.unsplash.com/photo-1555689502-c4b22d76c56f?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
        stock: 25,
        userId: createdUser.id,
      ...
      },
      {
        ...
        cost: 150.0,
        imageUrl:
          'https://images.unsplash.com/photo-1546868871-7041f2a55e12?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
        stock: 15,
        userId: createdUser.id,
        categoryId: createdCategories[2].id
      },
      ...
      },
      {
        ...
        cost: 8.0,
        imageUrl:
          'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
        stock: 100,
        userId: createdUser.id,
    ...
    const discounts = [
      {
        ...
        isActive: true,
        scope: 'category',
        scopeId: createdCategories[1].id,
        userId: createdUser.id
      },
      {
        name: 'New Customer',
      ...
      },
      {
        ...
        isActive: true,
        scope: 'category',
        scopeId: createdCategories[2].id,
        userId: createdUser.id
      }
    ]
    ...
    const orders = [
      ...
      },
      {
        ...
        shippingAddress: '101 Elm St, City, State, 12345',
        total: 299.99,
        status: 'delivered',
        paymentStatus: 'paid',
        escrowStatus: 'pending',
    ...
    const orderItems = [
      ...
      },
      {
        ...
        quantity: 2,
        total: createdProducts[3].price * 2
      },
      {
  ...
  async getProductsByTag(tagId: number): Promise<Product[]> {
    ...
    return Array.from(this.products.values()).filter(product => productIds.includes(product.id))
  }
  ...
  async getDiscounts(userId: number): Promise<Discount[]> {
    return Array.from(this.discounts.values()).filter(discount => discount.userId === userId)
  }
  ...
  async getReturns(userId: number): Promise<Return[]> {
    ...
    return Array.from(this.returns.values()).filter(returnItem => orderIds.includes(returnItem.orderId))
  }
  ...
  async getProductRevenue(
    ...
    const relevantOrderItems = Array.from(this.orderItems.values()).filter(item => orderIds.includes(item.orderId))
